...
const TIER1 = 124; // Tier-1 bubble size in px (10% smaller than 160)
const TIER2 = 104; // Tier-2 bubble size in px (30% larger than 80)

const linkedinSkillsUrl = (resumeData) => {
  const id = (resumeData && resumeData.linkedinId) || 'mattdbaldwin';
...
export default function Resume({ resumeData = {} }) {
  ...
  const skillsUrl = linkedinSkillsUrl(resumeData);
